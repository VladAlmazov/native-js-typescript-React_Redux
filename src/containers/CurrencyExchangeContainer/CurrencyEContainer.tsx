...
const CurrencyEContainer: React.FC = () => {
    ...
    // Не получаем никаких пропсов, стейт берем из хука useSelector
    ...
    const changeAction = (e: React.MouseEvent<HTMLSpanElement>) => {
        ...
        dispatch(e.currentTarget.dataset.action === 'buy'
            ? ChangeActionAC(true)
            : ChangeActionAC(false)
        );
    };
...
// Отказ от mapStateToProps, mapDispatchToProps, connect. Переход с классовой компоненты на функциональную
